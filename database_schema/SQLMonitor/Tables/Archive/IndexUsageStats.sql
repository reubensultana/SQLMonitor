...
CREATE TABLE [Archive].[IndexUsageStats](
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE object_id = OBJECT_ID(N'[Archive].[IndexUsageStats]') AND name = N'PK_IndexUsageStats_Archive')
ALTER TABLE [Archive].[IndexUsageStats]
